...
<div class="container mt-4">
    ...
    <p class="text-muted">Tambah,ubah dan hapus data paket wisata disini.</p>
    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modal-create">Tambah pakage</button>
            ...
            <div class="col-md-4 mb-3">
                <div class="card"><img class="card-img-top w-100 d-block img-fluid" src="/images/<?= $pakage['image']; ?>" />
                    <div class="card-body">
                        ...
                        <a href="/admin-pakage-edit/ <?= $pakage['id']; ?>" class="btn btn-primary" type="button">
...
<div id="modal-create" class="modal fade" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data" action="/admin-pakage-store">
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Paket Wisata</h4><button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
