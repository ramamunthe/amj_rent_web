...
<div class="container mt-4">
    ...
    <p class="text-muted">Tambah,ubah dan hapus data pelanggan disini.</p>
    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modal-create">Tambah Pelanggan</button>
            ...
            <div class="col-md-4 mb-3">
                <div class="card"><img class="card-img-top w-100 d-block img-fluid" src="/images/<?= $customer['image']; ?>" />
                    <div class="card-body">
                        ...
                        <a href="/admin-customer-edit/<?= $customer['id']; ?>" class="btn btn-primary" type="button">
